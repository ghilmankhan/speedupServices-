  ...
  en: {
    ...
    trustedPartners: {
      ...
      companies: [
        {
          id: 'unilever',
          name: { en: 'Unilever', ar: 'يونيليفر' },
          label: { en: 'Global Consumer Goods', ar: 'السلع الاستهلاكية العالمية' },
          logo: '/images/clients/unilever.png',
          logoWrapperClass: 'w-[92px]',
          logoClass: 'h-auto w-full object-contain',
        },
        {
          id: 'brandbuzz',
          name: { en: 'Brand Buzz', ar: 'براند باز' },
          label: { en: 'Branding & Activation', ar: 'الهوية وتنشيط العلامة' },
          logo: '/images/clients/brand-buzz.png',
          logoWrapperClass: 'w-[145px]',
          logoClass: 'h-auto w-full object-contain',
        },
        {
          id: 'mondelez',
          name: { en: 'Mondelez International', ar: 'مونديليز العالمية' },
          label: { en: 'Food & Beverage', ar: 'الأغذية والمشروبات' },
          logo: '/images/clients/mondelez.png',
          logoWrapperClass: 'w-[135px]',
          logoClass: 'h-auto w-full object-contain',
        },
        {
          id: 'helium',
          name: { en: 'Helium', ar: 'هيليوم' },
          label: { en: 'Retail & Consumer Marketing', ar: 'التجزئة وتسويق المستهلك' },
          logo: '/images/clients/helium.png',
          logoWrapperClass: 'w-[108px]',
          logoClass: 'h-auto w-full object-contain',
          useDarkLogoPanel: true,
        },
      ],
    },
    clientReviews: {
