...
export default function Logo({ className = "" }: { className?: string }) {
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <svg width="180" height="60" viewBox="0 0 180 60" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Speedup Services logo">
        <title>Speedup Services</title>
        {/* Speed in Black */}
        ...
        <rect x="85" y="25" width="4" height="6" fill="#1A1A1A" aria-label="Growth chart" />
        <rect x="92" y="20" width="4" height="11" fill="#1A1A1A" />
        <rect x="99" y="15" width="4" height="16" fill="#1A1A1A" />
        <path d="M106 10L111 0L116 10H106Z" fill="#1A1A1A" aria-label="Upward arrow" />
